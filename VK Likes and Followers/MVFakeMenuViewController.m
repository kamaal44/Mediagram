//
//  MVFakeMenuViewController.m
//  VK Likes and Followers
//
//  Created by whoami on 9/2/17.
//  Copyright © 2017 Mountain Viewer. All rights reserved.
//

#import "MVFakeMenuViewController.h"
...
@interface MVFakeMenuViewController ()
...
@implementation MVFakeMenuViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        cell.blackImageName = @"black_like";
        cell.whiteImageName = @"white_like";
        cell.cellImageView.image = [UIImage imageNamed:cell.blackImageName];
    } else if (indexPath.section == 0 && indexPath.row == 1) {
        cell.cellLabel.text = @"Подписчики";
        cell.cellLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:18];
        cell.cellLabel.textColor = [UIColor blackColor];
        cell.blackImageName = @"black_follower";
        cell.whiteImageName = @"white_follower";
        cell.cellImageView.image = [UIImage imageNamed:cell.blackImageName];
    } else if (indexPath.section == 0 && indexPath.row == 2) {
        cell.cellLabel.text = @"Мои подписки";
        cell.cellLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:18];
        cell.cellLabel.textColor = [UIColor blackColor];
        cell.blackImageName = @"black_star";
        cell.whiteImageName = @"white_star";
        cell.cellImageView.image = [UIImage imageNamed:cell.blackImageName];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        [self performSegueWithIdentifier:@"sw_likes" sender:self];
    } else if (indexPath.section == 0 && indexPath.row == 1) {
        [self performSegueWithIdentifier:@"sw_followers" sender:self];
    } else if (indexPath.section == 0 && indexPath.row == 2) {
        [self performSegueWithIdentifier:@"sw_subscriptions" sender:self];
    } else if (indexPath.section == 1 && indexPath.row == 0) {
        [self performSegueWithIdentifier:@"sw_coins" sender:self];
    } else if (indexPath.section == 1 && indexPath.row == 1) {
